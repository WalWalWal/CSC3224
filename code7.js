...
gdjs.PauseCode.condition3IsTrue_1 = {val:false};
...
gdjs.PauseCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10070564);
}
...
{
{gdjs.PauseCode.conditionTrue_1 = gdjs.PauseCode.condition2IsTrue_0;
gdjs.PauseCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10072452);
}
}}
}
...
{
{gdjs.PauseCode.conditionTrue_1 = gdjs.PauseCode.condition2IsTrue_0;
gdjs.PauseCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10073172);
}
}}
}
if (gdjs.PauseCode.condition2IsTrue_0.val) {
